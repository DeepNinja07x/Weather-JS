# Contribution
 If this is your first time to open source contribution and you know only HTML, CSS, or JS, then you have arrived at the right repository. 
...
-  Fork this [repository](https://github.com/DeepNinja07x/Weather-JS)
  
-  Clone the forked https://github.com/<Your_Username>/PyScripts
    > git clone https://github.com/<Your_Username>/Weather-JS.git
...
- Add the upstream (main project's) repo's URL
    ...
    > git remote add upstream https://github.com/DeepNinja07x/Weather-JS.git
